...
<form id="mgrForm" method="post" name="mgrForm"	action="com.primeton.governor.config.DataSourceConfig.flow?_eosFlowAction=actUniqueAdd" onsubmit="return checkForm(this);">
...
<table border="0" class="EOS_panel_body" width="100%">
	<tr>
		<td class="EOS_panel_head"><b:message key="gov_button.addPKDataSource"/></td>
	</tr>
	<tr>
		<td>
...
<tbody>
			<tr>
				...
				<h:hidden name="groupName" value="EOS-Unique"/>
				<td width="80%">EOS-Unique</td>
			</tr>
			...
			<tr>
				...
				<td>
					...
					<span id="isNotSupportJtaWarning" class="warn_msg_area"><b:message key="gov_tip.dsNotSupportJtaGlobalTransaction"/></span>
				</td>
			</tr>
</tbody>
<tbody id="jndialias" style="display:;" >
				<tr>
					...
					<td width="80%"><h:text id="jndialias_datasource" size="50"
						property="jndialias/jndiName" maxlength="64"
				...
				<tr>
					...
					validateAttr="allowNull=false;type=integer;minValue=-1" onblur="checkInput(this)" />
					</td>
				</tr>
				<tr>
...
function chckFrm(flag){
   ...
   if (submitType=="jdbc"){
		...
		if(!checkJndiName($id("jndialias_datasource"))) return;
